...
namespace MyTVStreamingService.Controllers
{
    public class RecommendedsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,userID,recommendedshow,count")] Recommended recommended)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,userID,recommendedshow,count")] Recommended recommended)
        {
